...
const PLANT_LIST = [
  "VAPL SDL", "VAPL SIKRI-2", "SHANKAR FORGE", "ASN RICO",
  "POLYPLASTIC-BHIWADI", 
  "VAPL DHATIR", "SKH-2", "VAPL BAWAL-1",
  "CUTTING EDGE DHATIR", "VAPL BAWAL", "BHAGWATI TECHNO",
  "NIROTECH", "SKH-1", "SATA VIKAS", "MT AUTOCRAFT ROHTAK",
  "SUNBEAM BAWAL", "KML", "P.P CHENNAI", "VAPL PRITHLA",
  "VAPL PATHREDI", "VAPL DHATIR B.O.P", "VIBROCAUSTIC",
  "NOIDA GLOBAL", "SKH-4", "PANCHKULA STEEL", "JRG","SEBROS",
];
